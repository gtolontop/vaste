    ...
    <div style={containerStyle}>
      ...
      {isNewServer && newLicenseKey && (
        <div style={successStyle}>
          <strong>Server created successfully!</strong><br />
      ...
      <div style={infoSectionStyle}>
        ...
        <div style={infoRowStyle}>
          ...
          <span 
            ...
            onClick={() => copyToClipboard(server.websocket_url)}
            title="Click to copy"
          >
        ...
        <div style={infoRowStyle}>
          ...
          <span style={valueStyle}>{server.host}:{server.port}</span>
        </div>
      ...
      <div style={infoSectionStyle}>
        ...
        <div style={infoRowStyle}>
          ...
          <div style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-end'}}>
            <span 
              style={licenseKeyStyle}
              onClick={licenseKeyVisible ? () => copyToClipboard(server.license_key || '') : handleLicenseKeyClick}
              title={licenseKeyVisible ? "Click to copy" : "Click to reveal"}
            >
        ...
        <div style={infoRowStyle}>
          ...
          <span style={valueStyle}>
            {new Date(server.license_expires_at).toLocaleDateString()}
          </span>
        </div>
