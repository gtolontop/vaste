...
const ServerListPage: React.FC = () => {
  ...
  const loadServers = useCallback(async (pageNum: number = 1, reset: boolean = false) => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={serversContainerStyle}>
        ...
        <div 
          style={serversListStyle} 
          className="server-list-scroll"
